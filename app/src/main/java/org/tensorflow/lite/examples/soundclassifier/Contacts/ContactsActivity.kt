...
class ContactsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.textDisclaimer.text =
            "Test would you like to share your discoveries with your friends?"
    ...
    private fun compareContacts(contacts: List<Map<String, String>>) {
        Toast.makeText(this, "Oops! Could not connect to our servers. Try again later.", Toast.LENGTH_SHORT).show()
